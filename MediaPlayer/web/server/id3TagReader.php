<?php
/**
 * Library module to dissect an MP3 files id3 tags and return them as a dictionary
 *
 * @author: anonymous
 *
 */
class ID3TagsReader {
    ...
    public function getInfo( ) {
        ...
        // read source file
        $iFSize = filesize($this->sFilepath);
        $vFD = fopen($this->sFilepath,'r');
        $sSrc = fread($vFD,$iFSize);
        fclose($vFD);

        // obtain base info
        if (substr($sSrc,0,3) == 'ID3') {
            $aInfo['FileName'] = $this->sFilepath;
